...
export default async function ArticleDetailPage({ params }: Props) {
  ...
  const others = ARTICLES.filter((a) => a.id !== article.id).slice(0, 3 - related.length);
      ...
      <section className="relative pt-28 pb-0 overflow-hidden bg-[#0D2B5B]">
        ...
        <div className="relative max-w-4xl mx-auto px-6 py-16">
          ...
          <nav className="flex items-center gap-2 font-mono text-xs text-white/40 mb-6">
            <Link href="/" className="hover:text-[#C89B3C] transition-colors">Accueil</Link>
            <span>/</span>
            <Link href="/actualites" className="hover:text-[#C89B3C] transition-colors">Actualités</Link>
            <span>/</span>
        ...
        <div className="max-w-4xl mx-auto grid lg:grid-cols-3 gap-12">
          ...
          <article className="lg:col-span-2 prose prose-lg max-w-none">
            ...
            <div className="space-y-5 font-body text-gray-700 leading-relaxed text-base">
              <p>
                Cette initiative marque une étape importante dans l&apos;engagement de Dr Désiré YASSO
                pour le développement de la 4e circonscription électorale. Depuis plusieurs mois,
                son équipe travaille en étroite collaboration avec les autorités locales, les
                organisations de la société civile et les partenaires au développement pour
              ...
              <p>
                Les bénéficiaires de cette action sont au cœur des préoccupations de Dr YASSO.
                Pour lui, chaque projet doit répondre à un besoin réel, exprimé par les
                communautés elles-mêmes. C&apos;est pourquoi une consultation préalable a été
                organisée dans les villages concernés, permettant de recueillir les attentes
                et d&apos;affiner les modalités de mise en œuvre.
              </p>
              <p>
                « Nous ne faisons pas les choses pour les gens, nous les faisons avec les gens »,
                a-t-il rappelé lors de la cérémonie. Cette philosophie participative est au cœur
                de sa démarche politique et sociale.
              </p>
              <h2 className="font-display text-2xl font-700 text-[#0D2B5B] mt-8 mb-3">
                Des perspectives prometteuses
              </h2>
              <p>
                Au-delà de l&apos;impact immédiat, cette initiative s&apos;inscrit dans une vision à long
                terme pour la 4e circonscription. Dr YASSO a présenté une feuille de route
                ambitieuse prévoyant plusieurs phases complémentaires, dont la formation des
                bénéficiaires, le suivi régulier des résultats et l&apos;extension progressive aux
                zones encore non couvertes.
              </p>
              <p>
                Les partenaires impliqués ont salué la qualité de l&apos;organisation et l&apos;engagement
                personnel de Dr YASSO, qui n&apos;a pas ménagé ses efforts pour mobiliser les
              ...
              <div className="my-8 bg-[#0D2B5B] p-6">
                <p className="font-display text-xl text-white italic leading-relaxed">
                  « Chaque action que nous posons aujourd&apos;hui est une graine plantée pour
              ...
              <p>
                Suite à cette réussite, de nouvelles actions sont d&apos;ores et déjà programmées.
                Dr YASSO a annoncé qu&apos;une deuxième phase sera lancée prochainement, avec des
                ambitions encore plus larges. Les habitants de Natitingou et Toucountouna
                peuvent se réjouir : leur champion n&apos;a pas l&apos;intention de s&apos;arrêter là.
              </p>
              <p>
                Pour rester informé de toutes les prochaines initiatives, suivez Dr Désiré
                YASSO sur les réseaux sociaux et abonnez-vous aux notifications de ce site.
              </p>
            </div>

            {/* Tags */}
            <div className="mt-10 flex flex-wrap gap-2">
              {[article.category, "Atacora", "Natitingou", "Développement"].map((tag) => (
                <span
                  key={tag}
            ...
            <div className="mt-8 pt-8 border-t border-gray-100 flex items-center gap-4">
              <span className="font-mono text-xs text-gray-400 tracking-wider uppercase">Partager :</span>
              {["Facebook", "Twitter / X", "WhatsApp", "Copier le lien"].map((s) => (
                <button
                  key={s}
          ...
          <aside className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-[#0D2B5B] p-6">
              ...
              <div className="flex items-center gap-3 mb-4">
                <div className="w-12 h-12 bg-[#C89B3C] flex items-center justify-center">
                  <span className="font-display font-bold text-white text-lg">DY</span>
                </div>
                <div>
                  <div className="font-display font-700 text-white text-sm">Dr Désiré YASSO</div>
                  <div className="font-mono text-[10px] text-white/50 mt-0.5">Docteur en Droit Public</div>
                </div>
              </div>
              <p className="font-body text-xs text-white/60 leading-relaxed mb-4">
                Enseignant-chercheur, conseiller municipal, candidat à l&apos;Assemblée Nationale pour la 4e circonscription de l&apos;Atacora.
              </p>
              <Link
            ...
            <div className="bg-gray-50 border border-gray-100 p-5">
              ...
              {["Santé", "Éducation", "Jeunesse", "Infrastructures", "International", "Femmes & Développement"].map((cat) => (
                <Link
                  key={cat}
                  href={`/actualites`}
